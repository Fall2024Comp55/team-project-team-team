...
public class battleGraphics  {
    ...
    public void winScreen() {
        ...
        timer.schedule(new TimerTask() {
            ...
            public void run() {
                ...
                if (playerMonster != null && playerMonster.getCurHealth() == 0 && playerMonster.isFainted()) {
                    ...
                    map.remove(playerMonsterSprite);
                    map.endBattle();
                    winMessage.setLabel("Player Wins! Wild Monster fainted.");
                }

                // Schedule a task to remove the winMessage after 2 seconds (2000ms)
                timer.schedule(new TimerTask() {
                    @Override
                    public void run() {
        ...
        }, 10000); // Initial delay before checking for the winner
    }
